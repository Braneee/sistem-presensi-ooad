...
<?php $__env->startSection('page-subtitle', 'Perbarui data mahasiswa: ' . $student->name); ?>

<?php $__env->startSection('content'); ?>
<div class="max-w-2xl">
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        <form action="<?php echo e(route('admin.students.update', $student)); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="text" name="nim" value="<?php echo e(old('nim', $student->nim)); ?>" required
                ...
                <div class="md:col-span-2">
                    ...
                    <?php if($student->photo): ?>
                        <div class="mb-2 flex items-center gap-3">
                            <img src="<?php echo e($student->photo_url); ?>" alt="Foto saat ini"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <select name="is_active"
                            class="w-full border border-gray-300 rounded-xl px-4 py-2.5 text-sm outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500">
                        <option value="1" <?php echo e(old('is_active', $student->is_active ? 1 : 0) == 1 ? 'selected' : ''); ?>>Aktif</option>
                        <option value="0" <?php echo e(old('is_active', $student->is_active ? 1 : 0) == 0 ? 'selected' : ''); ?>>Nonaktif</option>
                    </select>
                </div>
            </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\PROJECT OOAD\attendance-system\laravel\resources\views/admin/students/edit.blade.php ENDPATH**/ ?>