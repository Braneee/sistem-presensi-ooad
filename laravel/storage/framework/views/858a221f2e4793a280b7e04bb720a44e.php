...
<?php $__env->startSection('page-title', 'Data Kehadiran'); ?>
<?php $__env->startSection('page-subtitle', 'Riwayat seluruh presensi mahasiswa'); ?>
...
<div class="bg-white rounded-xl shadow-sm border border-gray-100 p-4 mb-5">
    <form method="GET" class="flex items-end gap-3 flex-wrap">
        <div>
            ...
            <select name="session_id"
                ...
                <?php $__currentLoopData = $sessions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($s->id); ?>" <?php echo e(request('session_id') == $s->id ? 'selected' : ''); ?>>
                        <?php echo e($s->title); ?> (<?php echo e($s->date->format('d/m/Y')); ?>)
                    </option>
        ...
        <?php if(request()->hasAny(['session_id','date','status'])): ?>
...
<div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
    <div class="px-5 py-4 border-b border-gray-100 flex items-center justify-between">
        ...
        <span class="text-xs text-gray-400"><?php echo e($attendances->total()); ?> record</span>
    </div>
                ...
                <tbody class="divide-y divide-gray-50">
                    <?php $__currentLoopData = $attendances; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $att): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="hover:bg-gray-50">
                            <td class="px-5 py-3">
                                <p class="font-medium text-gray-800"><?php echo e($att->student->name); ?></p>
                                <p class="text-xs text-gray-400 font-mono"><?php echo e($att->student->nim); ?></p>
                            </td>
                            <td class="px-5 py-3">
                                <p class="text-gray-700"><?php echo e($att->session->title); ?></p>
                                <p class="text-xs text-gray-400"><?php echo e($att->session->date->format('d/m/Y')); ?></p>
                            </td>
                            <td class="px-5 py-3 text-gray-600 text-xs">
                                <?php echo e($att->checked_in_at->format('d/m/Y H:i:s')); ?>
                            ...
                            <td class="px-5 py-3 text-center text-xs text-gray-500">
                                <?php echo e(number_format($att->similarity_score * 100, 1)); ?>%
                            </td>
                        </tr>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </tbody>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\PROJECT OOAD\attendance-system\laravel\resources\views/admin/attendance/index.blade.php ENDPATH**/ ?>