                ...
                <div class="mb-4">
                    ...
                    <input type="email"
                           ...
                           class="w-full px-4 py-2.5 border rounded-xl text-sm outline-none transition-all
                                  <?php echo e($errors->has('email') ? 'border-red-400 bg-red-50' : 'border-gray-300 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20'); ?>"
...
unset($__errorArgs, $__bag); ?>
        ...
        <p class="text-center mt-6">
            <a href="<?php echo e(route('attendance.index')); ?>" class="text-blue-100 hover:text-white text-sm transition-colors">
...
<?php /**PATH D:\PROJECT OOAD\attendance-system\laravel\resources\views/auth/login.blade.php ENDPATH**/ ?>