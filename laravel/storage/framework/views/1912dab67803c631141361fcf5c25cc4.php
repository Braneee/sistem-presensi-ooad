...
<?php $__env->startSection('page-subtitle', 'Daftarkan data wajah mahasiswa untuk sistem presensi'); ?>
...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-5">
    ...
    <div class="space-y-4">
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5">
            ...
            <div class="flex items-center gap-4 mb-4">
                ...
                <div>
                    ...
                    <p class="text-xs text-gray-500 font-mono"><?php echo e($student->nim); ?></p>
                    <p class="text-xs text-gray-500"><?php echo e($student->classRoom->name); ?></p>
                </div>
            </div>
            ...
            <dl class="space-y-2 text-sm">
                <div class="flex justify-between">
                    ...
                    <dd class="text-gray-700 text-xs"><?php echo e($student->email ?? '—'); ?></dd>
                </div>
                <div class="flex justify-between">
                    <dt class="text-gray-500">Jenis Kelamin</dt>
                    <dd class="text-gray-700"><?php echo e($student->gender === 'L' ? 'Laki-laki' : 'Perempuan'); ?></dd>
                </div>
                <div class="flex justify-between">
        ...
        <?php if($student->faces->count() > 0): ?>
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5">
                <h3 class="font-semibold text-gray-800 text-sm mb-3">Data Wajah Tersimpan</h3>
                <div class="space-y-3">
                    <?php $__currentLoopData = $student->faces; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $face): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
                            <?php if($face->photo_url): ?>
                                <img src="<?php echo e($face->photo_url); ?>" alt="Face" class="w-12 h-12 rounded-lg object-cover">
                            <?php endif; ?>
                            <div class="flex-1 min-w-0">
                                <p class="text-xs font-medium text-gray-700"><?php echo e($face->model_version); ?></p>
                                <p class="text-xs text-gray-400"><?php echo e($face->created_at->format('d/m/Y H:i')); ?></p>
                            </div>
                            <form action="<?php echo e(route('admin.faces.destroy', $face)); ?>" method="POST">
...
const STUDENT_ID = <?php echo e($student->id); ?>;
let regStream    = null;
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\PROJECT OOAD\attendance-system\laravel\resources\views/admin/faces/register.blade.php ENDPATH**/ ?>